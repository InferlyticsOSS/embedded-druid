...
package io.druid.embedded.smoosh;
...
import io.druid.embedded.Utils;
...
public class SmooshedFileMapper implements Closeable {
    ...
    public ByteBuffer mapFile(String name) throws IOException {
        ...
        ByteBuffer mappedBuffer = buffersList.get(fileNum);
        if (mappedBuffer == null) {
            mappedBuffer = Utils.readFile(outFiles.get(fileNum));
...
//        for (ByteBuffer mappedByteBuffer : buffersList) {
